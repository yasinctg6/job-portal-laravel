...
@section('title')
    Jobportal - Hire Freelancers &amp; Find Freelance Jobs Online
@endsection
...
@section('content')
    <section>
     <div class="jumbotron">
        <div class="mx-auto align-middle jumbotron-content">
            <div>
              <h1 class="display-4 h1" style="font-family: 'Big Shoulders Stencil Display', cursive; word-spacing: 10px;">Find The Job That Fits Your Skills</h1>
              <form action="/userdashboard" method="get">
                <div class="input-group mb-3 w-50">
                  ...
                  <div class="input-group-append">
                    <button class="input-group-text bg-success text-light" id="basic-addon" type="submit"><i class="fas fa-search"></i></button>
                  </div>
                </div>
              </form>
          </div>
    ...
    <section id="vectorimages" style="background-color: rgba(61,180,61,0.47)">
        ...
        <div class="col-sm pt-5 pb-5">
            <img src="{{asset('img/vector.jpg')}}" class="img-fluid">
        </div>
    </section>
@endsection